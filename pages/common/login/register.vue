...
<template>
    <view class="wsf-login">
        ...
        <form class="col">
            <view class="wsf-item">
                <tui-icon name="friendadd" color="#5677fc" :size="44" unit="rpx"></tui-icon>
            ...
            <view class="wsf-register">
                <navigator url="login" class="right" open-type="navigate">返回登录</navigator>
            </view>
        </form>
    </view>
</template>
<script>
    ...
    export default {
        data() {
            return {
                title: '注册新账号', //填写logo或者app名称，也可以用：欢迎回来
                second: 60, //默认60秒
