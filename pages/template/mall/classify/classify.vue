			...
			<scroll-view scroll-y class="right-box" :style="{ height: height + 'px', top: top + 'px' }" v-if="currentTab == index">
				...
				<view class="page-view">
					<swiper indicator-dots autoplay circular :interval="5000" :duration="150" class="swiper">
						<swiper-item v-if="index % 2 === 0" @tap.stop="detail"><image src="https://thorui.cn/images/mall/banner/2.jpg" class="slide-image"></image></swiper-item>
						<swiper-item @tap.stop="detail"><image src="https://thorui.cn/images/mall/banner/4.jpg" class="slide-image"></image></swiper-item>
						<swiper-item @tap.stop="detail"><image src="https://thorui.cn/images/mall/banner/5.jpg" class="slide-image"></image></swiper-item>
					</swiper>
						...
						<view class="class-item">
							...
							<view class="g-container">
								...
								<view class="g-box" @tap.stop="productList" data-key="抽纸">
									<image src="/static/images/product/55.jpg" class="g-image"></image>
