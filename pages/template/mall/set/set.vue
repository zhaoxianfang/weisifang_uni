<template>
	<view class="tui-set-box">
		<tui-list-cell padding="0" lineLeft="0" :arrow="true" @click="href(1)">
			<view class="tui-list-cell tui-info-box">
				<image src="/static/images/my/mine_def_touxiang_3x.png" class="tui-avatar"></image>
				<view>echo.</view>
			</view>
		</tui-list-cell>
		<tui-list-cell padding="0" lineLeft="0" :arrow="true" @click="href(2)">
		...
		<view class="tui-mtop">
			...
			<tui-list-cell padding="0" lineLeft="0" :arrow="true" @click="href(3)">
				<view class="tui-list-cell">
					消息提醒设置
				</view>
			</tui-list-cell>
		...
		<view class="tui-mtop">
			<tui-list-cell padding="0" lineLeft="0" :arrow="true" @click="href(4)">
				<view class="tui-list-cell">
					关于我们
				</view>
			</tui-list-cell>
			<tui-list-cell padding="0" lineLeft="0" :arrow="true" @click="href(5)">
				<view class="tui-list-cell">
					意见反馈
				</view>
			</tui-list-cell>
