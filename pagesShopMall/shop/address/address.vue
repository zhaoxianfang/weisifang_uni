<template>
	<view class="tui-safe-area">
				...
				<tui-list-cell padding="0">
					<view class="tui-address-flex">
						...
						<view class="tui-address-imgbox">
							<image class="tui-address-img" src="/static/images/template/cafe/icon_addr_edit.png" />
						</view>
					</view>
				</tui-list-cell>
			</block>
		...
		<view class="tui-address-new">
			<tui-button shape="circle" type="brown" height="80rpx" @click="editAddr">+ 新增收货地址</tui-button>
		</view>
	</view>
</template>
